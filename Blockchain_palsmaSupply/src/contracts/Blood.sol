...
contract Blood{
    ...
    address payable public admin = address(0x7F740ded6f584eBC266F71eDc5EC217AF279d2D2);
    address payable public hospi = address(0x6FCee595f4Ad642C44B709498bFE62Ec2E4756a2);
    ...
    constructor() public{
        name = "Abc Gor";
        userCount ++;
        usertype[admin] = User(userCount, 14, "Admin", admin, "Abc", '', '', "Punjab");
        users[userCount] = User(userCount, 14, "Admin", admin, "Abc", '', '', "Punjab");
    }
